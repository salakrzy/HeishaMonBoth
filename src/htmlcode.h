...
static const char webBodyRoot1[] PROGMEM =
  ...
  "<a href=\"/modbus\" class=\"w3-bar-item w3-button\">Modbus</a>"//#485
...
static const char webBodyRoot2[] PROGMEM =
  "<br><a href=\"https://github.com/salakrzy/HeishaMonBoth\">HeishaMonBoth software</a></div><hr></div>"//#485
...
static const char settingsForm2[] PROGMEM =
  ...
  "      <tr>"
  "        <td style=\"text-align:right; width: 50%\">"
  "          Debug log to loggingSerial (GPIO2):</td>"//####ESP32
  "        <td style=\"text-align:left\">"
