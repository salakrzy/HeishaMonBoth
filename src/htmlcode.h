static const char webHeader[] PROGMEM  =
  "<!DOCTYPE html>"
  "<html>"
  "<title>Heisha monitor BOTH</title>"
...
static const char webBodyStart[] PROGMEM =
  ...
  "<header class=\"w3-container w3-card w3-theme\"><h1>Heisha monitor BOTH</h1></header>";
...
static const char settingsForm2[] PROGMEM =
  ...
  "      <tr>"
  "        <td style=\"text-align:right; width: 50%\">"
  "        ON- only CZ-TAW1  OFF- CZ-TAW1 & MQTT mode:</td>"
  "        <td style=\"text-align:left\">"
  ...
  "      <tr>"
  "        <td style=\"text-align:right; width: 50%\">"
  "          Debug log to Serial (GPIO3):</td>"
  "        <td style=\"text-align:left\">"
  "          <input type=\"checkbox\" name=\"logSerial\" value=\"enabled\">"
  "        </td>"
  "      </tr>"
  "    </table>"
  "    <table style=\"width:100%\">"
