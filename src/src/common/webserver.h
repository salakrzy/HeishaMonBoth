...
typedef enum {
  ...
  WEBSERVER_CLIENT_REQUEST_METHOD=2,
  WEBSERVER_CLIENT_REQUEST_URI=3,
  WEBSERVER_CLIENT_READ_HEADER=4,
  WEBSERVER_CLIENT_CREATE_HEADER=5,
  WEBSERVER_CLIENT_WRITE=6,
  WEBSERVER_CLIENT_WEBSOCKET=7,
  WEBSERVER_CLIENT_WEBSOCKET_TEXT=8,
  WEBSERVER_CLIENT_SENDING=9,
  WEBSERVER_CLIENT_HEADER=10,
  WEBSERVER_CLIENT_ARGS=11,
  WEBSERVER_CLIENT_CLOSE=12,
} webserver_steps;
