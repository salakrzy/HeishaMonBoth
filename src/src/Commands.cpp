...
void send_heatpump_command(char* topic, char *msg, bool (*send_command)(byte*, int,int), void (*log_message)(char*), bool optionalPCB) {
  unsigned char cmd[256] = { 0 };
  char log_msg[256] = { 0 };
  unsigned int len = 0;
  unsigned int source = 0;  // rimi source 0 means MQTT requests
